...
<input type="text" name="name" id="inputName" class="form-control" value="<?php echo $getUserData2['name']; ?>" required="required" pattern="" title=""><br>
		...
		<label for="inputEmail" class="col-sm-2">Email: </label>
			<input type="email" name="email" id="inputEmail" class="form-control" value="<?php echo $getUserData2['email']; ?>" required="required" title="">
		</div><br>
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
		...
		<label for="inputPassword" class="col-sm-2">Zaporka: </label>
			<input type="text" name="password" id="inputPassword" class="form-control" value="<?php echo $getUserData2['password']; ?>" required="required" pattern="" title="">
		</div><br>
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
...
<?php
	...
	<div class="row">
		...
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
			...
			<button style="float:right;" type="button" onclick="updateUser();" class="btn btn-success">Spremi</button>
		</div>
	...
	.done(function(data) {
		...
		if (data == 1) {
			...
			alert("Korisnikovi podaci uspješno uređeni");
