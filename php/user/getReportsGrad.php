...
if ($date_to=='') {
	$date_to = '3000-01-01 00:00:00';
}

if ($string != '') 
{

	$getReport = mysql_query("SELECT * FROM lijekarne WHERE user = ".$id." AND checked = 1 AND timestamp >= '".$date_from."' AND timestamp <= '".$date_to."' AND (grad LIKE '%$string%');");
